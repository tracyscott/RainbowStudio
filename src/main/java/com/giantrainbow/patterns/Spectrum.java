...
public class Spectrum extends LXPattern {
    ...
    private CompoundParameter speedParameter = new CompoundParameter("Spd", 7000, 14000);


    public final SinLFO rainbowMotion = new SinLFO(
            0, // This is a lower bound
            360, // This is an upper bound
            speedParameter     // This is 3 seconds, 3000 milliseconds
    );
    ...
    protected void run(double deltaMs) {
        ...
        int pointNumber = 0;
        float rainbowEndHue = this.rainbowMotion.getValuef();
