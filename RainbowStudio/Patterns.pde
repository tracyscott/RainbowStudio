...
public class FlamingoRace extends PGPixelPerfect {
  ...
  public FlamingoRace(LX lx) {
    ...
    flamePositions[0] = ceil(imageWidth/2.0 * 0.33 - flameWidth/2.0);
    flamePositions[1] = ceil(imageWidth/2.0 * 0.67 - flameWidth/2.0);
    flamePositions[2] = ceil(imageWidth/2.0 + imageWidth/2.0 * 0.33 - flameWidth/2.0);
    flamePositions[3] = ceil(imageWidth/2.0 + imageWidth/2.0 * 0.66 - flameWidth/2.0 - 2);
  ...
  public void draw(double deltaMs) {
    ...
    try {
      ...
      pg.image(effigy[0], imageWidth/2.0 - effigy[0].width/2.0, framesUntilStart);
      if (!flamingo1Jump) { 
