 ...
 */
static public class RenderImageUtil {
  /*
   ...
   */
  static public void imageToPointsSemiCircle(LX lx, int[] colors, PImage image, boolean antialias) {
    ...
    for (LXPoint p : lx.model.points) {
      ...
      if (!antialias) {
        ...
        int verticalColor = RenderImageUtil.getWeightedColor(LXColor.add(belowColor, aboveColor), 0.5);
   ...
   */
   /*
  static public void imageToPointsBBox2(LX lx, int[] colors,
